        ...
        setContent {
            MovieCounter_ApCaTheme {
                Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
                    MovieCounterApCa(modifier = Modifier.padding(innerPadding))
                }
            }
        }
    }
...
@Composable
fun MovieCounterApCa(modifier: Modifier = Modifier) {
